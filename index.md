...
document.addEventListener("DOMContentLoaded", function() {
    // Select all tables generated by Pandas
    var tables = document.querySelectorAll('table.dataframe, table');
    ...
    tables.forEach(function(table) {
        ...
        if (!table.parentElement.classList.contains('table-wrapper')) {
            ...
            // Apply strict CSS styles directly to the wrapper
...
<style>
/* Ensure the table stays inside the wrapper we just made */
.table-wrapper table {
    width: 100%;
    max-width: 100%;
    white-space: nowrap; /* Forces wide tables to trigger scroll */
}
</style>
